...
protocol GeocodingLibraryPigeonInternalFinalizerDelegate: AnyObject {
...
internal final class GeocodingLibraryPigeonInternalFinalizer {
  ...
  internal weak var delegate: GeocodingLibraryPigeonInternalFinalizerDelegate?

  private init(identifier: Int64, delegate: GeocodingLibraryPigeonInternalFinalizerDelegate) {
    self.identifier = identifier
    self.delegate = delegate
  }

  internal static func attach(
    to instance: AnyObject, identifier: Int64, delegate: GeocodingLibraryPigeonInternalFinalizerDelegate
  ) {
    let finalizer = GeocodingLibraryPigeonInternalFinalizer(identifier: identifier, delegate: delegate)
  ...
  static func detach(from instance: AnyObject) {
    let finalizer = objc_getAssociatedObject(instance, associatedObjectKey) as? GeocodingLibraryPigeonInternalFinalizer
...
/// reference is removed and the weak reference is deallocated,`GeocodingLibraryPigeonInternalFinalizerDelegate.onDeinit`
...
final class GeocodingLibraryPigeonInstanceManager {
  ...
  private let lockQueue = DispatchQueue(label: "GeocodingLibraryPigeonInstanceManager")
  ...
  private let finalizerDelegate: GeocodingLibraryPigeonInternalFinalizerDelegate
  private var nextIdentifier: Int64 = minHostCreatedIdentifier

  public init(finalizerDelegate: GeocodingLibraryPigeonInternalFinalizerDelegate) {
  ...
  private func addInstance(_ instance: AnyObject, withIdentifier identifier: Int64) {
    ...
    GeocodingLibraryPigeonInternalFinalizer.attach(to: instance, identifier: identifier, delegate: finalizerDelegate)
  }
  ...
  /// `GeocodingLibraryPigeonInstanceManager` to have, or recreate, a weak reference to the Dart instance the
  ...
  func removeAllObjects() throws {
    lockQueue.sync {
      ...
      while let instance = weakInstancesEnumerator.nextObject() {
        GeocodingLibraryPigeonInternalFinalizer.detach(from: instance as AnyObject)
      }
      identifiers.removeAllObjects()
      weakInstances.removeAllObjects()
      strongInstances.removeAllObjects()
      nextIdentifier = GeocodingLibraryPigeonInstanceManager.minHostCreatedIdentifier
    }
  }
...
private class GeocodingLibraryPigeonInstanceManagerApi {
  /// The codec used for serializing messages.
  var codec: FlutterStandardMessageCodec { GeocodingLibraryPigeonCodec.shared }
  ...
  /// Sets up an instance of `GeocodingLibraryPigeonInstanceManagerApi` to handle messages through the `binaryMessenger`.
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, instanceManager: GeocodingLibraryPigeonInstanceManager?) {
    let codec = GeocodingLibraryPigeonCodec.shared
...
protocol GeocodingLibraryPigeonProxyApiDelegate {
...
open class GeocodingLibraryPigeonProxyApiRegistrar {
  let binaryMessenger: FlutterBinaryMessenger
  let apiDelegate: GeocodingLibraryPigeonProxyApiDelegate
  let instanceManager: GeocodingLibraryPigeonInstanceManager
  ...
  var codec: FlutterStandardMessageCodec {
    if _codec == nil {
      _codec = FlutterStandardMessageCodec(
        readerWriter: GeocodingLibraryPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: self))
    }
    return _codec!
  }

  private class InstanceManagerApiFinalizerDelegate: GeocodingLibraryPigeonInternalFinalizerDelegate {
    let api: GeocodingLibraryPigeonInstanceManagerApi

    init(_ api: GeocodingLibraryPigeonInstanceManagerApi) {
      self.api = api
    }
  ...
  init(binaryMessenger: FlutterBinaryMessenger, apiDelegate: GeocodingLibraryPigeonProxyApiDelegate) {
    self.binaryMessenger = binaryMessenger
    self.apiDelegate = apiDelegate
    self.instanceManager = GeocodingLibraryPigeonInstanceManager(
      finalizerDelegate: InstanceManagerApiFinalizerDelegate(
        GeocodingLibraryPigeonInstanceManagerApi(binaryMessenger: binaryMessenger)))
  }

  func setUp() {
    GeocodingLibraryPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, instanceManager: instanceManager)
  ...
  func tearDown() {
    GeocodingLibraryPigeonInstanceManagerApi.setUpMessageHandlers(binaryMessenger: binaryMessenger, instanceManager: nil)
...
private class GeocodingLibraryPigeonInternalProxyApiCodecReaderWriter: FlutterStandardReaderWriter {
  unowned let pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar

  private class GeocodingLibraryPigeonInternalProxyApiCodecReader: GeocodingLibraryPigeonCodecReader {
    unowned let pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar

    init(data: Data, pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar) {
  ...
  private class GeocodingLibraryPigeonInternalProxyApiCodecWriter: GeocodingLibraryPigeonCodecWriter {
    unowned let pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar

    init(data: NSMutableData, pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar) {
      self.pigeonRegistrar = pigeonRegistrar
      super.init(data: data)
    }
    ...
    override func writeValue(_ value: Any) {
      ...
      if let instance = value as AnyObject?, pigeonRegistrar.instanceManager.containsInstance(instance)
      {
        ...
        assert(false, "Unsupported value for GeocodingLibraryPigeonInternalProxyApiCodecWriter")
      }

    }
  }

  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar) {
    self.pigeonRegistrar = pigeonRegistrar
  }

  override func reader(with data: Data) -> FlutterStandardReader {
    return GeocodingLibraryPigeonInternalProxyApiCodecReader(data: data, pigeonRegistrar: pigeonRegistrar)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return GeocodingLibraryPigeonInternalProxyApiCodecWriter(data: data, pigeonRegistrar: pigeonRegistrar)
  }
}
...
private class GeocodingLibraryPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    switch type {
    case 129:
...
private class GeocodingLibraryPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
...
private class GeocodingLibraryPigeonCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return GeocodingLibraryPigeonCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return GeocodingLibraryPigeonCodecWriter(data: data)
  }
}

class GeocodingLibraryPigeonCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  static let shared = GeocodingLibraryPigeonCodec(readerWriter: GeocodingLibraryPigeonCodecReaderWriter())
}
...
final class PigeonApiCLFloor: PigeonApiProtocolCLFloor  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLFloor) {
    self.pigeonRegistrar = pigeonRegistrar
...
final class PigeonApiCLGeocoder: PigeonApiProtocolCLGeocoder  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLGeocoder) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiCLGeocoder?) {
    let codec: FlutterStandardMessageCodec =
      ...
      ? FlutterStandardMessageCodec(
        readerWriter: GeocodingLibraryPigeonInternalProxyApiCodecReaderWriter(pigeonRegistrar: api!.pigeonRegistrar))
...
final class PigeonApiCLLocation: PigeonApiProtocolCLLocation  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLLocation) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiCLLocationCoordinate2D: PigeonApiProtocolCLLocationCoordinate2D  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLLocationCoordinate2D) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiCLLocationSourceInformation: PigeonApiProtocolCLLocationSourceInformation  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLLocationSourceInformation) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiCLPlacemark: PigeonApiProtocolCLPlacemark  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCLPlacemark) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiCNPostalAddress: PigeonApiProtocolCNPostalAddress  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateCNPostalAddress) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiLocale: PigeonApiProtocolLocale  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateLocale) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
...
final class PigeonApiNSObject: PigeonApiProtocolNSObject  {
  ...
  init(pigeonRegistrar: GeocodingLibraryPigeonProxyApiRegistrar, delegate: PigeonApiDelegateNSObject) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
